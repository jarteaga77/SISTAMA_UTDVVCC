package ordenesCompraCSS.presentacion;
...
import ordenCompraCSS.dominio.ordenCompra.DaoDetalleOrdenCompraCSS;
import ordenCompraCSS.dominio.ordenCompra.DaoOrdenCompraCSS;
import ordenCompraCSS.dominio.ordenCompra.Detalle_orden_compraCSS;
import ordenCompraCSS.dominio.ordenCompra.OrdenCompraCSS;
 ...
 * @author jarteaga
 */
public class JIFOrdenesCompraCSS extends javax.swing.JInternalFrame {


    private ConexionBD conexion=new ConexionBD();
    private DefaultTableModel modelo;
  //private int contador=0;
    private ReporteOrdenCompraCAS jasper;
   ...
   //Se declara la variable tipo vector Array
    ...
    try
    {
        ...
        ResultSet obj=conexion.executeQuery("SELECT nombre_ccostos FROM css.centro_costos");//Consulta para traer el nombre de centro de costos
       ...
       ResultSet obj3=conexion.executeQuery("SELECT MAX(consecutivo_orden_compra)+1 as consecutivo  FROM ordenescompra.orden_compra_css");
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Ordenes de Compra-CSS");
        ...
        txt_area_con.setText("Favor facturar a nombre CSS Constructores S.A, NIT 832.006.599-5, *fecha*\nTiempo de entrega: Inmediato .\nForma de pago: Crédito 30 días\nSitio de entrega: Km 14 Recta Cali - Palmira, entrada al CIAT.\n");
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
         OrdenCompraCSS orden=new OrdenCompraCSS();
         DaoOrdenCompraCSS dao=new DaoOrdenCompraCSS();
         int id_item=0;
         ConexionBD nueva=new ConexionBD();
              ...
              if(cb_item.getSelectedItem()!=null)
            {
                ...
                ResultSet obj2=nueva.executeQuery("SELECT id_item_ccostos_cc FROM css.item_ccostos_cc WHERE nombre_ccostos_cc='"+item_ccostos+"'");
            try {                
                while(obj2.next())
                {
    ...
    private void btn_imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_imprimirActionPerformed
        jasper=new ReporteOrdenCompraCAS();
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
        Detalle_orden_compraCSS detalle=new Detalle_orden_compraCSS();
        DaoDetalleOrdenCompraCSS dao=new DaoDetalleOrdenCompraCSS();
...
//        }
    ...
    private void btn_modActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modActionPerformed
        ...
        if(tabla_detalle.isRowSelected(tabla_detalle.getSelectedRow()))
        {
             ...
             {
                 ResultSet obj=nueva.executeQuery("SELECT item_det_orden,descripcion,referencia,cantidad,vlor_unitario,dto_comercial,codigo_sinco FROM ordenescompra.detalle_orden_compra_css WHERE id_detalle_orden_compra="+modelo.getValueAt(row,0)+" AND consecutivo_ordencompra="+txt_orden.getText()+"");
                 try {
                     if(obj.next()==true)
                     {
                         ...
                         nueva.executeUpdateQuery("DELETE FROM ordenescompra.detalle_orden_compra_css WHERE id_detalle_orden_compra="+modelo.getValueAt(row,0)+" AND consecutivo_ordencompra="+txt_orden.getText()+"");
   ...
   public void detalleTabla()
   {
       try
        {
            ...
            ResultSet obj=nueva.executeQuery("SELECT detalle.id_detalle_orden_compra,detalle.item_det_orden,detalle.descripcion,detalle.cantidad,uni.unidad,detalle.vlor_unitario, detalle.dto_comercial,detalle.iva,detalle.total "
                    + "FROM ordenescompra.detalle_orden_compra_css detalle JOIN unidad_medida uni ON detalle.id_unidad=uni.id_unidad "
     ...
     public void buscarOrden()
    {
        try
        {
            ...
            ResultSet obj=nueva.executeQuery("SELECT nit_proveedor,requisicion,cargoa_orden,dto_financiero,cotizacion,observacion,condiciones FROM ordenescompra.orden_compra_css WHERE consecutivo_orden_compra="+txt_orden.getText()+" AND id_usuario="+idusuario+"");
     ...
     public void actualizarTotales() throws SQLException
     {
         ...
         ResultSet obj=nueva.executeQuery("SELECT to_char(SUM(detalle.subtotal),'999G999G999G999D99')AS subtotal, to_char(SUM(detalle.dto_comercial),'999G999G999G999D99')AS descuento,"
                 ...
                 + "FROM ordenescompra.detalle_orden_compra_css detalle JOIN ordenescompra.orden_compra_css orden ON orden.consecutivo_orden_compra=detalle.consecutivo_ordencompra "
