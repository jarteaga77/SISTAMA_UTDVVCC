...
import cotizacion.dominio.cotizacionesMVVCC.DaoCotizacionMVVCC;
import cotizacion.dominio.cotizacionesMVVCC.DaoDetalleCotizacionMVVCC;
import cotizacion.dominio.cotizacionesMVVCC.cotizacionMVVCC;
import cotizacion.dominio.cotizacionesMVVCC.detalle_cotizacionMVVCC;
 ...
 * @author jarteaga
 */
public class JIFCotizacionMvvcc extends javax.swing.JInternalFrame {

    private ConexionBD nueva =new ConexionBD();
    private cotizacionMVVCC cot; 
    private DaoCotizacionMVVCC daoCot;
    private detalle_cotizacionMVVCC detalle;
    private DaoDetalleCotizacionMVVCC dao_detalle;
    private int cant_cotizaciones=0;
    private ReporteCotizacionMVVCC jasper;
    private JIFProveedor jifproveedor;
    private static long nit;
    private int contador=0;
    private LimpiarCampos limpiar =new LimpiarCampos();
    ...
    public JIFCotizacionMvvcc() {
        initComponents();
        
        
        detalle=new detalle_cotizacionMVVCC();
        dao_detalle=new DaoDetalleCotizacionMVVCC();
        
        date_fecha_cotizacion.setDate(new Date());
        modelo= new DefaultTableModel(); 
        jasper=new ReporteCotizacionMVVCC();
   
    try
    {
        
        ResultSet obj=nueva.executeQuery("SELECT nombre_ccostos FROM mvvcc.centro_costos ");
       ...
       ResultSet obj3=nueva.executeQuery("SELECT MAX(consecutivo_cotizacion)+1 as consecutivo  FROM cotizaciones.cotizacion_mvvcc");
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle(" Cotizaciones  - MVVCC");
        setPreferredSize(new java.awt.Dimension(1010, 761));

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.setPreferredSize(new java.awt.Dimension(990, 705));
        ...
        panel_cotizacionLayout.setHorizontalGroup(
            ...
            .addGroup(panel_cotizacionLayout.createSequentialGroup()
                .addGroup(panel_cotizacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(panel_cotizacionLayout.createSequentialGroup()
                ...
                .addGroup(panel_cotizacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_cotizacionLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cb_item, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel7)
                        .addGap(18, 18, 18)
                        .addComponent(txt_cargoA, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        panel_detalleLayout.setHorizontalGroup(
            ...
            .addGroup(panel_detalleLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_detalle, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel9)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cb_und, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        label_nit.setText("8300596483");

        label_empresa.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        label_empresa.setText("MVVCC");

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UTDVVCC/recursos/logoutdvvcc.png"))); // NOI18N
        ...
        pane_encabezadoLayout.setVerticalGroup(
            ...
            .addGroup(pane_encabezadoLayout.createSequentialGroup()
                ...
                .addGroup(pane_encabezadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel11)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pane_encabezadoLayout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(panel_cotizacion, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(312, 312, 312)
    ...
    private void b_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarActionPerformed
      try
     {
          ...
          cot=new cotizacionMVVCC();
          daoCot=new DaoCotizacionMVVCC();
          ...
          if(cb_ccostos.getSelectedItem()!=null)
          {
              ...
              ResultSet obj=nueva.executeQuery("SELECT id_ccostos FROM mvvcc.centro_costos WHERE nombre_ccostos='"+centro+"'");
                ...
                while(obj.next())
                {
                    centro_costos=obj.getInt("id_ccostos");
          ...
          if(cb_item.getSelectedItem()!=null)
          {
              ...
              ResultSet obj2=nueva.executeQuery("SELECT id_item_ccostos_mvvcc FROM mvvcc.item_ccostos WHERE nombre_item_mvvcc='"+item+"'");
            
              while(obj2.next())
              {
                  id_item_ccostos=obj2.getInt("id_item_ccostos_mvvcc");
         ...
         cot.setId_usuario(idusuario);
          ...
          label_consecutivo.setText(String.valueOf(DaoCotizacionMVVCC.getIdCotizacion()));
    ...
    private void b_imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_imprimirActionPerformed
        jasper.ejecutarReporte(Integer.parseInt(label_consecutivo.getText()));
    ...
    private void cb_proveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_proveedorActionPerformed
        if(cb_proveedor.getSelectedItem()!=null)
        {
            try {
                ...
                Logger.getLogger(JIFCotizacionMvvcc.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     try
       {
        ...
        if(contador <= cant_cotizaciones)       
        {
            ...
            JD_detalle_cotizacion.dispose();
            nueva.executeUpdateQuery("UPDATE cotizaciones.detalle_cotizacion_mvvcc SET estado="+true+" WHERE subtotal IN (SELECT MIN(subtotal) FROM cotizaciones.detalle_cotizacion_mvvcc WHERE item="+txt_item.getText()+" AND consecutivo_cotizacion="+label_consecutivo.getText()+") AND item="+txt_item.getText()+" AND consecutivo_cotizacion="+label_consecutivo.getText()+"");
    ...
    try
        {
            ResultSet obj=nueva.executeQuery("SELECT d.id_detalle_cotizacion, d.nit_proveedor, d.item,d.detalle_prod_servicio,d.referencia,d.cantidad_prod_servicio,d.vlor_unitario,d.subtotal "
                    + "FROM cotizaciones.cotizacion_mvvcc c JOIN cotizaciones.detalle_cotizacion_mvvcc d ON c.consecutivo_cotizacion=d.consecutivo_cotizacion  where c.consecutivo_cotizacion= "+label_consecutivo.getText()+" ORDER BY d.item ASC");
