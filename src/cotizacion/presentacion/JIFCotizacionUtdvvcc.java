...
import cotizacion.dominio.cotizaciones.DaoCotizacion;
import cotizacion.dominio.cotizaciones.DaoDetalleCotizacion;
import cotizacion.dominio.cotizaciones.cotizacion;
import cotizacion.dominio.cotizaciones.detalle_cotizacion;
 ...
 * @author jarteaga
 */
public class JIFCotizacionUtdvvcc extends javax.swing.JInternalFrame {

    private  ConexionBD nueva =new ConexionBD();
    private  cotizacion cot; 
    private  DaoCotizacion daoCot;
    private  detalle_cotizacion detalle;
    private  DaoDetalleCotizacion dao_detalle;
    ...
    private LimpiarCampos limpiar =new LimpiarCampos();//objeto que limpia los campos que se encuentra en los paneles
    
    private DefaultTableModel modelo;
    public static MDIPrincipal principal;
    
    public JIFCotizacionUtdvvcc() {
        initComponents();
        detalle=new detalle_cotizacion();
        dao_detalle=new DaoDetalleCotizacion();
    ...
    try
    {
        ...
        ResultSet obj=nueva.executeQuery("SELECT sigla_ccostos FROM utdvvcc.centrocostos ");
        
        while(obj.next())
        {
            cb_ccostos.addItem(obj.getObject("sigla_ccostos"));
        }
       ...
       ResultSet obj3=nueva.executeQuery("SELECT MAX(consecutivo_cotizacion)+1 as consecutivo  FROM cotizaciones.cotizacion");
    ...
    {
        return JIFCotizacionUtdvvcc.nit;
    }
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle(" Cotizaciones  - UTDVVCC ");
        setPreferredSize(new java.awt.Dimension(940, 773));

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.setPreferredSize(new java.awt.Dimension(840, 720));
            ...
            .addGroup(panel_cotizacionLayout.createSequentialGroup()
                .addGroup(panel_cotizacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panel_cotizacionLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cb_ccostos, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(panel_cotizacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_cotizacionLayout.createSequentialGroup()
                        .addGap(35, 35, 35)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_cotizacionLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cb_item, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(36, 36, 36)
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_cargoA, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_cotizacionLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
        ...
        panel_detalleLayout.setHorizontalGroup(
            ...
            .addGroup(panel_detalleLayout.createSequentialGroup()
                ...
                .addGap(6, 6, 6)
                .addComponent(txt_item, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel8)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_detalle, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(panel_detalle, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap())
    ...
    private void b_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarActionPerformed
      try
     {
          ...
          if(cb_ccostos.getSelectedItem()!=null)
          {
              ...
              ResultSet obj=nueva.executeQuery("SELECT id_centrocostos FROM utdvvcc.centrocostos WHERE sigla_ccostos='"+centro+"'");
              
                while(obj.next())
                {
                    centro_costos=obj.getInt("id_centrocostos");
          ...
          if(cb_item.getSelectedItem()!=null)
          {
              ...
              ResultSet obj2=nueva.executeQuery("SELECT id_item_ccostos FROM utdvvcc.itemccostos WHERE nombre_item_ccostos='"+item+"'");
            
              while(obj2.next())
              {
                  id_item_ccostos=obj2.getInt("id_item_ccostos");
         ...
         cot.setId_usuario(idusuario);
          ...
          label_consecutivo.setText(String.valueOf(DaoCotizacion.getIdCotizacion()));
   ...
   try
       {
        ...
        if(contador <= cant_cotizaciones)       
        {
            ...
            JD_detalle_cotizacion.dispose();
            nueva.executeUpdateQuery("UPDATE cotizaciones.detalle_cotizacion SET estado="+true+" WHERE subtotal IN (SELECT MIN(subtotal) FROM cotizaciones.detalle_cotizacion WHERE item="+txt_item.getText()+" AND consecutivo_cotizacion="+label_consecutivo.getText()+") AND item="+txt_item.getText()+" AND consecutivo_cotizacion="+label_consecutivo.getText()+"");
    ...
    try
        {
            ResultSet obj=nueva.executeQuery("SELECT d.id_detalle_cotizacion, d.nit_proveedor, d.item,d.detalle_prod_servicio,d.referencia,d.cantidad_prod_servicio,d.vlor_unitario,d.subtotal "
                    + "FROM cotizaciones.cotizacion c JOIN cotizaciones.detalle_cotizacion d ON c.consecutivo_cotizacion=d.consecutivo_cotizacion  WHERE c.consecutivo_cotizacion= "+label_consecutivo.getText()+" ORDER BY d.item ASC");
