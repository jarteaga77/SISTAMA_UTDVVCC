 ...
 * @author jarteaga
 */
public class ReporteCotizacionMVVCC 

{
    
  private Conexion nueva=new Conexion();//Variable  de tipo conexion
  private final String logo="/UTDVVCC/recursos/logoutdvvcc.png";//Ruta del logo de la empresa
    ...
    public void ejecutarReporte(int  cotizacion)
    {
        ...
        URL  in = this.getClass().getResource("/cotizacion/reporte/reporteCotizacion_mvvcc.jasper");//Ruta del reporte maestro
        URL  in1 = this.getClass().getResource("/cotizacion/reporte/resumen_cotizacion_mvvcc.jasper");//Ruta del subreporte
        URL in2= this.getClass().getResource("/cotizacion/reporte/reporte_total_resumen_mvvcc.jasper");
        ...
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("Cotizaciones MVVCC");
