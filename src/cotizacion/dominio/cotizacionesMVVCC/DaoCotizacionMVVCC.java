 ...
 * @author jarteaga
 */
public class DaoCotizacionMVVCC 

{
    ...
    public static long getIdCotizacion() {
        return DaoCotizacionMVVCC.id_cotizacion;
    }

    public static void setIdCotizacion(long id_cotizacion) {
        DaoCotizacionMVVCC.id_cotizacion = id_cotizacion;
    }
    
    
    public void guardar(cotizacionMVVCC cot)
    {
        try
        {
      
       ResultSet obj= nueva.executeQuery("INSERT INTO cotizaciones.cotizacion_mvvcc (fecha_cotizacion,centro_costos,item_ccostos,cargo_a,fecha_trans_cotizacion,id_usuario)VALUES"
