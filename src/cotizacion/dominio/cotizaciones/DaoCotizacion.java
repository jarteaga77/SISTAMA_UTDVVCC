...

{
    ...
    private static long id_cotizacion;
     ...
     public static long getIdCotizacion() {
        return DaoCotizacion.id_cotizacion;
    }

    public static void setIdCotizacion(long id_cotizacion) {
        DaoCotizacion.id_cotizacion = id_cotizacion;
    }
    
    
    public void guardar(cotizacion cot)
    {
        try
        {
      
     ResultSet obj= nueva.executeQuery("INSERT INTO cotizaciones.cotizacion (fecha_cotizacion,centro_costos,item_ccostos,cargo_a,fecha_trans_cotizacion,id_usuario)VALUES"
