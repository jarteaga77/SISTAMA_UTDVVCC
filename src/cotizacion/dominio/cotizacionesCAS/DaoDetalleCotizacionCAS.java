 ...
 * @author jarteaga
 */
public class DaoDetalleCotizacionCAS 
{
    
    ConexionBD nueva =new ConexionBD();
    
    public void guardarDetalle(detalle_cotizacionCAS detalle)
    {
        try
        {
        ...
        nueva.executeUpdateQuery("INSERT INTO cotizaciones.detalle_cotizacion_cas (nit_proveedor,item,detalle_prod_servicio,cantidad_prod_servicio,vlor_unitario,cotizacion,estado,consecutivo_cotizacion,id_unidad,subtotal,requisicion,descuento,referencia)VALUES"
