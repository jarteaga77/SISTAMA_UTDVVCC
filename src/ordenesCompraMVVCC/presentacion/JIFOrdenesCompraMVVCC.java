package ordenesCompraMVVCC.presentacion;
...
import ordenCompraMVVCC.dominio.ordenesCompra.DaoDetalleOrdenCompra_MVVCC;
import ordenCompraMVVCC.dominio.ordenesCompra.DaoOrdenCompraMVVCC;
import ordenCompraMVVCC.dominio.ordenesCompra.Detalle_orden_compra_MVVCC;
import ordenCompraMVVCC.dominio.ordenesCompra.OrdenCompraMVVCC;
 ...
 * @author jarteaga
 */
public class JIFOrdenesCompraMVVCC extends javax.swing.JInternalFrame {


    private ConexionBD conexion=new ConexionBD();
    private DefaultTableModel modelo;
    //private int contador=0;
    private ReporteOrdenCompraMVVCC jasper;
   ...
   //Se declara la variable tipo vector Array
    ...
    try
    {
        ...
        ResultSet obj=conexion.executeQuery("SELECT nombre_ccostos FROM mvvcc.centro_costos ");//Consulta para traer el nombre de centro de costos
       ...
       ResultSet obj3=conexion.executeQuery("SELECT MAX(consecutivo_orden_compra)+1 as consecutivo  FROM ordenescompra.orden_compra_mvvcc");
    ...
    private void initComponents() {
        ...
        txt_cod_sinco = new javax.swing.JTextField();
        ...
        txt_vlor_unit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_vlor_unitActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txt_cod_sinco))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(jLabel9)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txt_refe, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(txt_cant, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel12)
                                .addGap(18, 18, 18)
                                .addComponent(cb_um, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(txt_descripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 318, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_dto_com, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel7)
                            .addComponent(jLabel20)
                            .addComponent(txt_cod_sinco, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel9)
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Ordenes de Compra-UTCMVVCC");
        setPreferredSize(new java.awt.Dimension(830, 838));

        jPanel1.setPreferredSize(new java.awt.Dimension(793, 783));

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Orden de Compra"));
        jPanel2.setPreferredSize(new java.awt.Dimension(766, 457));
        ...
        chb_dto_fin.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        txt_area_con.setText("Favor facturar a nombre UNION TEMPORAL PARA LA CONSTRUCCIÓN MVVCC,\nNIT 830.058.648-3, *fecha*\nTiempo de entrega: Inmediato .\nForma de pago: Crédito 30 días\nSitio de entrega: Km 14 Recta Cali - Palmira, entrada al CIAT.\n");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cb_proveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 434, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(cb_item, javax.swing.GroupLayout.PREFERRED_SIZE, 342, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_proveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(779, 216));
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
         OrdenCompraMVVCC orden=new OrdenCompraMVVCC();
         DaoOrdenCompraMVVCC dao=new DaoOrdenCompraMVVCC();
         int id_item=0;
         ConexionBD nueva=new ConexionBD();
              ...
              if(cb_item.getSelectedItem()!=null)
            {
                ...
                ResultSet obj2=nueva.executeQuery("SELECT id_item_ccostos_mvvcc FROM mvvcc.item_ccostos WHERE nombre_item_mvvcc='"+item_ccostos+"'");
            try {                
                while(obj2.next())
                {
    ...
    private void btn_imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_imprimirActionPerformed
        jasper=new ReporteOrdenCompraMVVCC();
    ...
    private void cb_ccostosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_ccostosActionPerformed
        try
        {
            ...
            if(cb_ccostos.getSelectedItem()!=null)
            {
                ...
                ResultSet obj=nueva.executeQuery("SELECT id_ccostos FROM mvvcc.centro_costos WHERE nombre_ccostos='"+centro+"'");
            ...
            ResultSet obj2=nueva.executeQuery("SELECT nombre_item_mvvcc FROM mvvcc.item_ccostos WHERE id_ccostos_mvvcc="+id_ccostos+" ");

            while(obj2.next())
            {
                cb_item.addItem(obj2.getObject("nombre_item_mvvcc"));
            }
            nueva.desconectar();
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
        Detalle_orden_compra_MVVCC detalle=new Detalle_orden_compra_MVVCC();
        DaoDetalleOrdenCompra_MVVCC dao=new DaoDetalleOrdenCompra_MVVCC();
...
//        } 
        ...
        if(cb_iva.getSelectedItem().equals("%0"))
        {
           ...
           detalle.setCod_sinco(Long.parseLong(txt_cod_sinco.getText()));
...
//            Logger.getLogger(JIFOrdenesCompraMVVCC.class.getName()).log(Level.SEVERE, null, ex);
//        }
    ...
    private void btn_modActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modActionPerformed
        ...
        if(tabla_detalle.isRowSelected(tabla_detalle.getSelectedRow()))
        {
             ...
             {
                 ResultSet obj=nueva.executeQuery("SELECT item_det_orden,descripcion,referencia,cantidad,vlor_unitario,codigo_sinco FROM ordenescompra.detalle_orden_compra_mvvcc WHERE id_detalle_orden="+modelo.getValueAt(row,0)+" AND consecutivo_ordencompra="+txt_orden.getText()+"");
                 try {
                     if(obj.next()==true)
                     {
                         ...
                         txt_cod_sinco.setText(String.valueOf(detalle.getCod_sinco()));
                         txt_dto_com.setText("0");
                         ...
                         nueva.executeUpdateQuery("DELETE FROM ordenescompra.detalle_orden_compra_mvvcc WHERE id_detalle_orden="+modelo.getValueAt(row,0)+" AND consecutivo_ordencompra="+txt_orden.getText()+"");
...
//        }
    ...
    private void txt_vlor_unitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_vlor_unitActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_vlor_unitActionPerformed
    ...
    private javax.swing.JTextField txt_cod_sinco;
   ...
   public void detalleTabla()
   {
       try
        {
            ...
            ResultSet obj=nueva.executeQuery("SELECT detalle.id_detalle_orden,detalle.item_det_orden,detalle.descripcion,detalle.cantidad,uni.unidad,detalle.vlor_unitario, detalle.dto_comercial,detalle.iva,detalle.total "
                    + "FROM ordenescompra.detalle_orden_compra_mvvcc detalle JOIN unidad_medida uni ON detalle.id_unidad=uni.id_unidad "
     ...
     public void buscarOrden()
    {
        try
        {
            ...
            ResultSet obj=nueva.executeQuery("SELECT nit_proveedor,requisicion,cargoa_orden,dto_financiero,cotizacion,observacion,condiciones FROM ordenescompra.orden_compra_mvvcc WHERE consecutivo_orden_compra="+txt_orden.getText()+" AND id_usuario="+idusuario+"");
     ...
     public void actualizarTotales() throws SQLException
     {
         ...
         ResultSet obj=nueva.executeQuery("SELECT to_char(SUM(detalle.subtotal),'999G999G999G999D99')AS subtotal, to_char(SUM(detalle.dto_comercial),'999G999G999G999D99')AS descuento,"
                 ...
                 + "FROM ordenescompra.detalle_orden_compra_mvvcc detalle JOIN ordenescompra.orden_compra_mvvcc orden ON orden.consecutivo_orden_compra=detalle.consecutivo_ordencompra "
