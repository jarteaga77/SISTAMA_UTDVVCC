...

{
    ...
    public void guardarOrden(ordenCompra orden)
    {
        try
        {
           ResultSet obj= nueva.executeQuery("INSERT INTO ordenescompra.orden_compra_civsas(fecha_transaccion,nit_proveedor,id_itemccostos,id_requisicion,cotizacion,cargoa_orden,dto_financiero,observacion,id_usuario,condiciones)VALUES"
