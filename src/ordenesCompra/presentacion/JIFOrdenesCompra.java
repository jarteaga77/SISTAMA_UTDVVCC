...
import UTDVVCC.dominio.general.ControllerItemList;
import UTDVVCC.dominio.general.ItemCentroCostos;
...
import ordenesCompra.dominio.ordenesCompra.DaoDetalleOrdenCompra;
import ordenesCompra.dominio.ordenesCompra.DaoOrdenCompra;
import ordenesCompra.dominio.ordenesCompra.Requisicion;
import ordenesCompra.dominio.ordenesCompra.detalle_orden_compra;
import ordenesCompra.dominio.ordenesCompra.ordenCompra;
 ...
 * @author jarteaga
 */
public class JIFOrdenesCompra extends javax.swing.JInternalFrame {
    ...
    private int id_ccostos, id_item;
   ...
   //Se declara la variable tipo vector Array
    ...
    try
    {
        ...
        ResultSet obj=conexion.executeQuery("SELECT sigla_ccostos FROM utdvvcc.centrocostos ");//Consulta para traer el nombre de centro de costos
        
        while(obj.next())
        {
            cb_ccostos.addItem(obj.getObject("sigla_ccostos"));//Llena JCombobox con el nombre del centro de costos
        }
       ...
       ResultSet obj3=conexion.executeQuery("SELECT MAX(consecutivo_orden_compra)+1 as consecutivo  FROM ordenescompra.orden_compra");
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Ordenes de Compra - UTD");
        ...
        cb_ccostos.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        ...
        cb_item.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        ...
        btn_buscar_req.setToolTipText("Buscar Requisición");
        ...
        txt_area_con.setText("Favor facturar a nombre UNION TEMPORAL DESARROLLO VIAL DEL VALLE DEL CAUCA Y CAUCA,\nNIT 830.059.605-1, *fecha*\nTiempo de entrega: Inmediato .\nForma de pago: Crédito 30 días\nSitio de entrega: Km 14 Recta Cali - Palmira, entrada al CIAT.\n");
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    .addComponent(cb_ccostos, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(cb_item, javax.swing.GroupLayout.PREFERRED_SIZE, 414, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addGap(5, 5, 5)
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(panel_botones3, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            }
        ...
        orden.setId_item_ccostos(id_item);
        orden.setCargo_orden(txt_cargo_a.getText());
        orden.setRequisicion(Integer.parseInt(txt_requision.getText()));
        orden.setCotizacion(txt_cotizacion.getText());
        orden.setObservacion(txt_area_obs.getText());
        orden.setDto_financiero(Integer.parseInt(txt_dto_fin.getText()));
    ...
    private void cb_ccostosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_ccostosActionPerformed
        try
        {
            ...
            if(cb_ccostos.getSelectedItem()!=null)
            {
                ...
                ResultSet obj=conexion.executeQuery("SELECT id_centrocostos FROM utdvvcc.centrocostos WHERE sigla_ccostos='"+centro+"'");
...
//        } 
    ...
    private void btn_modActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modActionPerformed
        ...
        if(tabla_detalle.isRowSelected(tabla_detalle.getSelectedRow()))
        {
             ...
             {
                 ResultSet obj=nueva.executeQuery("SELECT item_det_orden,descripcion,referencia,cantidad,vlor_unitario,dto_comercial FROM ordenescompra.detalle_orden_compra WHERE id_detalle_orden_compra="+modelo.getValueAt(row,0)+" AND consecutivo_ordencompra="+txt_orden.getText()+"");
                 try {
                     if(obj.next()==true)
                     {
                         ...
                         nueva.executeUpdateQuery("DELETE FROM ordenescompra.detalle_orden_compra WHERE id_detalle_orden_compra="+modelo.getValueAt(row,0)+" AND consecutivo_ordencompra="+txt_orden.getText()+"");
   ...
   public void detalleTabla()
   {
       try
        {
            ...
            ResultSet obj=nueva.executeQuery("SELECT detalle.id_detalle_orden_compra,detalle.item_det_orden,detalle.descripcion,detalle.cantidad,uni.unidad,detalle.vlor_unitario, detalle.dto_comercial,detalle.iva,detalle.total "
                    + "FROM ordenescompra.detalle_orden_compra detalle JOIN unidad_medida uni ON detalle.id_unidad=uni.id_unidad "
     ...
     public void buscarOrden()
    {
        try
        {
            ...
            ResultSet obj=nueva.executeQuery("SELECT nit_proveedor,id_requisicion,cargoa_orden,dto_financiero,cotizacion,observacion,condiciones FROM ordenescompra.orden_compra WHERE consecutivo_orden_compra="+txt_orden.getText()+" AND id_usuario="+idusuario+"");
                ...
                if(obj.next()==true)
                {
                    ...
                    orden.setRequisicion(obj.getInt("id_requisicion"));
     ...
     public void actualizarTotales() throws SQLException
     {
         ...
         ResultSet obj=nueva.executeQuery("SELECT to_char(SUM(detalle.subtotal),'999G999G999G999D99')AS subtotal, to_char(SUM(detalle.dto_comercial),'999G999G999G999D99')AS descuento,"
                 ...
                 + "FROM ordenescompra.detalle_orden_compra detalle JOIN ordenescompra.orden_compra orden ON orden.consecutivo_orden_compra=detalle.consecutivo_ordencompra "
