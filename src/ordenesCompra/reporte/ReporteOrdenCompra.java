...

{
  ...
  //private final String pie="/UTDVVCC/recursos/pie.png";
    ...
    public void ejecutarReporte(int  ordenCompra)
    {
        ...
        URL  in = this.getClass().getResource("/ordenesCompra/reporte/Ordenes_Compra_Reporte.jasper");//Ruta del reporte maestro
        URL  in1 = this.getClass().getResource("/ordenesCompra/reporte/reporte_ordenes_compra_total.jasper");//Ruta del subreporte
        URL in2= this.getClass().getResource("/ordenesCompra/reporte/reporte_cuadro_comparativo.jasper");
        ...
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("Orden de Compra UTDVVCC");
